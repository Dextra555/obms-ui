...
export class ClientMasterComponent implements OnInit {
  ...
  displayedColumns: string[] = ['client_code','branch_code', 'client_name', 'address', 'person_incharge', 'Status', 'gstin', 'pan_number', 'indian_state', 'pin_code', 'compliance_status', 'action'];
  dataSource: any;
  errorMessage: string = '';
  currentUser: string = '';
